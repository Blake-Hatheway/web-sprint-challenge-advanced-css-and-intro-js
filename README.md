...
Making a website format on a broad array of devices and content viewable to people with any disability.

2. Talk about 3 different things you can do to ensure your website is accessible. 

structure content for screen readers, pick a color palet that works for color blind people, @media queries for viewability on any device.
...
to make your program do something.
